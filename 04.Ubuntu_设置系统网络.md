...
**注意：在应用防火墙配置之前请仔细阅读防火墙配置文件，并根据实际情况调整以下内容。**  
...
- 配置文件中监听的网卡名为 `bridge1` ，请根据实际情况进行调整  

- 配置文件中内网域名为 `fox.internal` ，请根据实际情况进行调整  

- 请检查配置文件中 DHCP 服务器相关参数，并根据实际情况进行调整  
...
## 下载 SmartDNS 安装包
$ curl -LR -O https://github.com/pymumu/smartdns/releases/download/Release47.1/smartdns.1.2025.11.09-1443.x86_64-linux-all.tar.gz
